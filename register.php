			...
			<div class="wrap-login100">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter Contact Number">
						<input class="input100" type="number" name="cno" placeholder="Contact Number">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					...
					<div class="contact100-form-checkbox">
						...
						<input class="input-checkbox100" id="ckb2" type="checkbox" name="type">
						<label class="label-checkbox100" for="ckb2">
							Urban
						</label>
						<input class="input-checkbox100" id="ckb3" type="checkbox" name="type">
